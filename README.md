...
This repository contains the static files for a GitHub Pages website. The site is intended to be simple, fast, and easy to maintain with plain HTML and related web assets.
...
See [`LICENSE`](LICENSE) for repository usage terms.
